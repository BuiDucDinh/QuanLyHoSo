<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HT_DMHuyen.aspx.cs" Inherits="HT_HT_DMHuyen" %>
...
<body>
    ...
    <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="150">
        <Items>
            <ext:TextField ID="txtMa_Huyen" FieldLabel="Mã huyện" runat="server" Hidden="false" />
            <ext:TextField ID="txtTen_Huyen" runat="server" FieldLabel="Tên huyện" Width="350"
                Margins="2" IndicatorText="*" />            
            <ext:ComboBox ID="cboMa_Tinh" runat="server" FieldLabel="Tên tỉnh" Width="150" EmptyText="--Chọn Tỉnh--"
                ...
                <DirectEvents>
                    <Select OnEvent="cboMa_Tinh_Change" />
                </DirectEvents>
            </ext:ComboBox>          
            ...
            <ext:GridPanel ID="gridData" runat="server" Title="Danh sách dữ liệu" Margins="0 0 5 5"
                ...
                <Store>
                    <ext:Store ID="dsData" runat="server" RemoteSort="true" DataSourceID="odsData" OnRefreshData="dsData_RefreshData">
                        ...
                        <SortInfo Field="Ma_Tinh,STT" Direction="ASC" />
                    </ext:Store>
                </Store>
                <ColumnModel ID="ColumnModel1" runat="server">
                    <Columns>
                        <ext:Column ColumnID="Ma_Huyen" DataIndex="Ma_Huyen" Header="Mã huyện" Hidden="false" />
                        <ext:Column ColumnID="Ten_Huyen" DataIndex="Ten_Huyen" Header="Tên huyện"
                            Width="200" />
