<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoaiQuyTrinh.aspx.cs" Inherits="HT_DanhMucQuyTrinh" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="150" Padding="10">
            <Items>
                <ext:TextField ID="txtTenLoai" runat="server" FieldLabel="Tên loại quy trình" Width="500" Margins="2" AllowBlank="false" IndicatorText="*" />
                <ext:TextArea ID="txtMota" runat="server" FieldLabel="Mô tả" Width="500" Height="150" />
                <ext:NumberField ID="txtStt" runat="server" FieldLabel="Số thứ tự" Width="100" />
                ...
                <ext:GridPanel ID="gvData" runat="server" Title="" Margins="0 0 5 5" Header="false"
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column ColumnID="TenLoai" DataIndex="TenLoai" Header="Tên loại quy trình" Width="400" />
