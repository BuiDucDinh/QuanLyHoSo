<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HT_DanToc.aspx.cs" Inherits="HT_HT_DanToc" %>
...
<body>
    ...
    <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="150">
        <Items>
            <ext:TextField ID="txtMa_Dan_Toc" runat="server" FieldLabel="Mã dân tộc" Hidden="false"  Margins="2" IndicatorText="*" />
            <ext:TextField ID="txtTen_Dan_Toc" runat="server" FieldLabel="Tên dân tộc" Width="350"
            ...
            <ext:GridPanel ID="gridData" runat="server" Title="Danh sách dữ liệu" Margins="0 0 5 5"
                ...
                <Store>
                    <ext:Store ID="dsData" runat="server" RemoteSort="true" DataSourceID="odsData" OnRefreshData="dsData_RefreshData">
                        ...
                        <SortInfo Field="Ma_Dan_Toc" Direction="ASC" />
                    </ext:Store>
                </Store>
                <ColumnModel ID="ColumnModel1" runat="server">
                    <Columns>
                        <ext:Column ColumnID="Ma_Dan_Toc" DataIndex="Ma_Dan_Toc" Header="Mã dân tộc" Hidden="false" />
                        <ext:Column ColumnID="Ten_Dan_Toc" DataIndex="Ten_Dan_Toc" Header="Tên dân tộc"
                            Width="200" />
