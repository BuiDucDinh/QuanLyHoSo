<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Template/Site.master" CodeFile="DanhMucDiSan.aspx.cs" Inherits="Template_DanhMucDiSan" %>
    ...
    <div class="left-main">
        <div class="module">
            <div class="module-title">
                <a href="#" class="TitleCate" title="<%=tendanhmuc %>">
                ...
                <asp:Repeater runat="server" ID="rptDiSan">
                    <ItemTemplate>
                        <div class="new block-cate">
                            <a href="<%#Eval("url") %>">
                                <img src="/FileUpload/images/<%#Eval("AnhDaiDien") %>" class="img-responsive home-img" style="height:235px"/>
                            </a>
                            <div class="info">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    var size = 2;
                    if (size > 10) size = 10;
                    $('#pagination').smartpaginator({ totalrecords: totalrow, recordsperpage: size, lenght: 10, datacontainer: 'divs', dataelement: '.new', initval: 0, next: 'Next', prev: 'Prev', first: 'First', last: 'Last', theme: 'black' });
                });
            </script>
