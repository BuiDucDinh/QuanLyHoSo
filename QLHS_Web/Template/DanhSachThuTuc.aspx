<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Template/Site.master" CodeFile="DanhSachThuTuc.aspx.cs" Inherits="Template_DanhSachThuTuc" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="left-main">
        <div class="module">
            ...
            <div class="module-content" style="padding: 0 15px;">
                        ...
                        <ItemTemplate>
                            <div class="new-item-search">
                                <a href="<%#Eval("url") %>" class="new-title">
                                    <h3>
                                        <%#Container.ItemIndex+1 %> :  <%#Eval("TenLoai") %></h3>
                                </a>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $('#pagination').smartpaginator({ totalrecords: totalrow, recordsperpage: 20, lenght: 4, datacontainer: 'divs', dataelement: '.new-item-search', initval: 0, next: 'Next', prev: 'Prev', first: 'First', last: 'Last', theme: 'black' });
                    });
                </script>
            </div>
        </div>
