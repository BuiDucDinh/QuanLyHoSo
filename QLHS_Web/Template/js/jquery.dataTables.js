/*! DataTables 1.10.0-devrecords per page
...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sLoadingRecords && zeroRecords &&
			oDefaults.sLoadingRecords === "Đang tải..." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
            //"sInfo": "Hiển thị từ _START_ tới _END_ trong tổng số _TOTAL_ bản ghi",
            "sInfo": "Display from _START_ to _END_ in _TOTAL_ record",
			 ...
			 *    } );
			 */
            //"sInfoEmpty": "Hiển thị từ 0 tới 0 trong tổng số 0 bản ghi",
			 ...
			 *    } );
			 */
            //"sInfoFiltered": "(tìm kiếm trong tổng số _MAX_ bản ghi)",
			"sInfoFiltered": "(search in _MAX_ record)",
