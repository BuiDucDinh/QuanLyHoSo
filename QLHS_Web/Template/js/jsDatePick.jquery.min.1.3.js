g_l = [];
g_l.MONTHS_SHORT = ["Janaury", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
g_l.MONTHS = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"];
...
JsDatePick = function (a) {
    ...
    this.monthsTextualRepresentation = g_l.MONTHS_SHORT;
...
JsDatePick.prototype.makeCalendar = function () {
    ...
    b.onmouseup = function () {
        var d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber"));
        d.setTooltipText("");
        d.setC(this, "jsDatePickCloseButton"); d.closeCalendar()
    };
...
JsDatePick.prototype.makeDOMWeekDays = function (a) {
    ...
    for (c = this.oConfiguration.weekStartDay;
        c < 7; c++) {
            ...
            this.setC(b, "weekDay"); b.appendChild(e); a.appendChild(b)
    }
...
JsDatePick.prototype.populateMainBox = function (h) {
    ...
    if (m < 0) { m = m + 7 } e = 0; for (e = 0; e < m; e++) {
        ...
        g.onmouseup = function () {
            var d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")), i;
            i = d.getCurrentColorScheme(); if (parseInt(this.getAttribute("isJsDatePickDisabled")) == 1) {
                return
            }
            if (parseInt(this.getAttribute("isToday")) == 1) {
                d.setC(this, "dayNormalToday");
        ...
        if (this.isSelectedDay(j.getDate())) {
            ...
            b = this.getCurrentColorScheme(); if (parseInt(g.getAttribute("isToday")) == 1) {
                if (k) {
                    this.setC(g, "dayDisabled"); g.style.background = "url(" + this.oConfiguration.imgPath + this.oConfiguration.cellColorScheme + "_dayNormal.gif) left top no-repeat"
                }
                else {
...
JsDatePick.prototype.getSelectedDayFormatted = function () {
    ...
    if (this.flag_DayMarkedBeforeRepopulation) {
        ...
        if (parseInt(this.lastMarkedDayObject.getAttribute("isToday")) == 1) {
            ...
            this.setC(this.lastMarkedDayObject, "dayNormal"); this.lastMarkedDayObject.style.background = "url(" + this.oConfiguration.imgPath + b + "_dayNormal.gif) left top no-repeat"
        }
    } this.flag_aDayWasSelected = true; this.selectedDayObject.year = this.currentYear;
    this.selectedDayObject.month = this.currentMonth;
    this.selectedDayObject.day = parseInt(a.innerHTML);
    this.flag_DayMarkedBeforeRepopulation = true;
    this.lastMarkedDayObject = a; $(a).attr("isSelected", 1); if (parseInt(a.getAttribute("isToday")) == 1) {
        this.setC(a, "dayDownToday"); a.style.background = "url(" + this.oConfiguration.imgPath + b + "_dayDown.gif) left top no-repeat"
    }
    else {
        this.setC(a, "dayDown"); a.style.background = "url(" + this.oConfiguration.imgPath + b + "_dayDown.gif) left top no-repeat"
    }
};
...
JsDatePick.prototype.setControlBarText = function (a) {
    var b = document.createTextNode(a); $(this.controlsBarTextCell).empty();
    this.controlsBarTextCell.appendChild(b)
};
JsDatePick.prototype.setTooltipText = function (a) {
    $(this.tooltip).empty(); var b = document.createTextNode(a);
...
JsDatePick.prototype.moveForwardOneMonth = function () {
    if (this.currentMonth < 12) {
        ...
        if (this.moveForwardOneYear()) { this.currentMonth = 1 }
        else {
...
JsDatePick.prototype.getDOMControlBar = function () {
    ...
    f.onmousedown = function () {
        ...
        i = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")); i.setTooltipText(g_l.MONTH_FWD); i.setC(this, "monthForwardButtonDown")
    };
    f.onmouseup = function () {
        ...
        d.setC(this, "monthForwardButton"); d.moveForwardOneMonth()
    };
    g.onmouseover = function () {
        var i, d; if (parseInt(this.getAttribute("isJsDatePickDisabled")) == 1) {
            return
    ...
    g.onmouseup = function () {
        ...
        d.setC(this, "monthBackwardButton"); d.moveBackOneMonth()
    };
    b.onmouseover = function () {
        var i, d;
        if (parseInt(this.getAttribute("isJsDatePickDisabled")) == 1) {
    ...
    b.onmousedown = function () {
        ...
        d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")); d.setTooltipText(g_l.YEAR_FWD);
        ...
        d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")); d.setTooltipText(g_l.YEAR_FWD);
        d.setC(this, "yearForwardButton"); d.moveForwardOneYear()
    };
    a.onmouseover = function () {
        var i, d; if (parseInt(this.getAttribute("isJsDatePickDisabled")) == 1) {
            return
        } i = this.parentNode; while (i.className != "controlsBar") { i = i.parentNode }
        d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber"));
    ...
    a.onmouseup = function () {
        ...
        d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber"));
        d.setTooltipText(g_l.YEAR_BCK); d.setC(this, "yearBackwardButton");
        d.moveBackOneYear()
    };
    return c
};