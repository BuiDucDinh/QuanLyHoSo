...
using QLHS_Logic;
using System.Data;
public partial class Common_ctlDonViYTeNs : System.Web.UI.UserControl
{
    ...
    protected void cboLoaiHinhChon_Selected(object sender, DirectEventArgs e)
    {
        ...
        else if (cboLoaiHinhChon.Value.ToString() == Sys_Common.G_LOAI_HINH_CHON_TUYEN_DIEU_TRI.ToString()) //Tuyến điều trị
        {
            ...
            DataTable myData = Sys_Common.RunTableBySQL("SELECT * FROM HT_Don_Vi_YT WHERE Loai_Hinh IN (4,5,6) and Ma_Tinh = '" + Sys_Common.G_MA_TINH + "'");
