<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlDonViYTe_AT_CoSo.ascx.cs" Inherits="Common_ctlDonViYTe_AT_CoSo" %>
    ...
    <Items>
        <ext:TableLayout ID="TableLayout1" runat="server" Columns="4">
            <Cells>
                ...
                <ext:Cell>
                    <ext:ComboBox ID="cboDonViChon" runat="server" FieldLabel="&nbsp;&nbsp;Xã" Width="350" EmptyText="--Chọn Xã--"
                        DisplayField="Ten_Xa" ValueField="Ma_Xa" Mode="Local" AllowBlank="true" LabelWidth="50">
                        <Items>
                            <ext:ListItem Value="" Text="--Chọn Xã--" />
                        </Items>
                        <Store>
