<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlDonViYTe_Notborder.ascx.cs" Inherits="Common_ctlDonViYTe_Notborder" %>
<ext:Panel runat="server" ID="pnlDonViChon" Border="false" Layout="HBoxLayout" Padding="5"
    Margins="0 0 5 5">
    <Items>
        <ext:TableLayout ID="tbc" runat="server" Columns="4" StyleSpec="NotBorder">
            <Cells>
                <ext:Cell >
