...
using QLHS_Logic;
using System.Data;
public partial class Common_ctlDonViYTe_AT : System.Web.UI.UserControl
{
    ...
    {
        DataTable myTable = Sys_Common.RunTableBySQL("SELECT Ma_Don_Vi, Ten_Don_Vi FROM HT_Don_Vi_YT WHERE Ma_Huyen='" + cboMaHuyenChon.Value.ToString() + "' order by Loai_Hinh ");
        if (myTable != null)
        {
