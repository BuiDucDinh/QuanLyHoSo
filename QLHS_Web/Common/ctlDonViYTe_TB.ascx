<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlDonViYTe_TB.ascx.cs" Inherits="Common_ctlDonViYTe_TB" %>
                ...
                <ext:Cell>
                    <ext:ComboBox ID="cboLoaiHinhChon" runat="server" FieldLabel="Loại hình" Width="200"
                        ...
                        <Items>
                            ...
                            <ext:ListItem Value="2" Text="Tuyến tỉnh" />
                        </Items>
                        <DirectEvents> 
                            <Select OnEvent="cboLoaiHinhChon_Selected">
                            </Select>
                            <Change OnEvent="cboLoaiHinhChon_Changed">
                            </Change>
                        </DirectEvents>
                    </ext:ComboBox>
                </ext:Cell>
