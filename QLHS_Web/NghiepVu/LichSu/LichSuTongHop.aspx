<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LichSuTongHop.aspx.cs" Inherits="NghiepVu_LichSu_LichSuTongHop" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="100">
            <Content>
                <ext:Panel runat="server" ID="pnLoc" Padding="10" Border="false" Width="450" LabelWidth="150">
                    <Items>
                        <ext:Hidden runat="server" ID="hdRole" />
                        <ext:ComboBox runat="server" ID="cmbNguoidung" FieldLabel="Chọn người dùng" Width="400" DisplayField="Ten_Dang_Nhap" ValueField="Ma_Nguoi_Dung">
                            <Store>
                                <ext:Store runat="server" ID="stNguoidung">
                                    <Reader>
                                        <ext:JsonReader>
                                            <Fields>
                        ...
                        <ext:GridPanel ID="gvData" runat="server"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="TenND" DataIndex="TenND" Header="Tên tài khoản" Width="150" />
