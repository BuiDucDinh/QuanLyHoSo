<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HoiDongThamDinh.aspx.cs" Inherits="NghiepVu_Danhmuc_HoiDongThamDinh" %>
            ...
            var getRecordFilter = function () {
                ...
                f.push({
                    filter: function (record) {     
                        return filterString(#{txtSTen}.getValue(), "TenHoiDong", record);
                    }
                });
        ...
        <ext:Viewport runat="server" LabelWidth="100" Padding="10" Layout="border">
            <Items>
                        ...
                        <ext:GridPanel ID="gvData" runat="server" Frame="true"
                                    ...
                                    <Reader>
                                        <ext:JsonReader IDProperty="ID">
                                            <Fields>
                                                ...
                                                <ext:RecordField Name="TenHoiDong" SortDir="ASC" />
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="TenThoiKy" DataIndex="TenHoiDong" Header="Hội đồng thẩm định" />
                ...
                <ext:Panel runat="server" Region="Center" Split="true" Padding="5"
                    Frame="true" DefaultAnchor="100%" Width="300" Icon="House">
                    <Items>
                        <ext:Hidden runat="server" ID="hdID" />
                        <ext:TextField ID="txtTen" runat="server" FieldLabel="Tên hội đồng" Width="600" Margins="2" IndicatorText="*" />
