<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhNhanVanHoa.aspx.cs" Inherits="NghiepVu_Danhmuc_DanhNhanVanHoa" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="150" Padding="10">
            <Items>
                ...
                <ext:TextField ID="txtTenDanhNhan" runat="server" FieldLabel="Tên danh nhân" Width="350" Margins="2" IndicatorText="*" />
                <ext:TextField ID="txtThoidai" runat="server" FieldLabel="Thời đại" Width="350" />
                <ext:HtmlEditor ID="txtMota" runat="server" FieldLabel="Tiểu sử danh nhân" Width="600" />
                <ext:NumberField runat="server" ID="txtStt" FieldLabel="Số thứ tự hiển thị" Width="350" />
                <ext:GridPanel ID="gvData" runat="server" Title="" Margins="0 0 5 5" Header="false"
                    ...
                    <Store>
                        <ext:Store ID="stData" runat="server" RemoteSort="true" DataSourceID="odsData" OnRefreshData="stData_RefreshData">
                            ...
                            <Reader>
                                <ext:JsonReader IDProperty="DanhNhanID">
                                    <Fields>
                                        <ext:RecordField Name="DanhNhanID" />
                                        <ext:RecordField Name="TenDanhNhan" SortDir="ASC" />
                                        <ext:RecordField Name="Thoidai" />
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column ColumnID="TenDanhNhan" DataIndex="TenDanhNhan" Header="Danh nhân" Width="150" />
                            <ext:Column ColumnID="Thoidai" DataIndex="Thoidai" Header="Thời đại sống" Width="100" />
                            <ext:Column ColumnID="MoTa" DataIndex="MoTa" Header="Tiểu sử danh nhân" Sortable="false" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
