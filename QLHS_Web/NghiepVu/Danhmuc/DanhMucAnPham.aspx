<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhMucAnPham.aspx.cs" Inherits="NghiepVu_Danhmuc_ChucVu" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="ViewPort1" runat="server" Layout="FormLayout" LabelWidth="150">
            <Items>
                ...
                <ext:TextField ID="txtTendanhmuc" runat="server" FieldLabel="Tên chức vụ" Hidden="false" Width="200" Margins="2" IndicatorText="*" />
